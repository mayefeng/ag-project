...
@Component({
  selector: 'app-horizonal-grid',
  templateUrl: './horizonal-grid.component.html',
  styleUrls: ['./horizonal-grid.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class HorizonalGridComponent implements OnInit {
  @Input() cols = 8;
  @Input() displayCols = 5;
  sliderMargin = '0'
